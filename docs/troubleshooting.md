...
**실제:** 설계 의도를 모르면서 이유를 추론해 사실처럼 말한 것. 근거 없는 단정이었다. (할루시네이션이 아니라 미지의 의도를 단정한 것.)

**교훈:** AI가 설계 의도를 모를 때는 "모른다"고 해야 한다.

---

### 발견 2 — RiskAssessmentAgent 과설계: rule engine 역할을 LLM으로 수행
